...
![Web Audio API](https://img.shields.io/badge/Web_Audio_API-Procedural-purple?style=for-the-badge)

---

## ✨ Features

- **🎧 100% Procedural Soundscapes (No External Audio Files)**:
  - **Gentle Rain & Drops**: Filtered pink noise + real-time stochastic raindrop impulse synthesis.
  - **Cozy Fireplace**: Filtered brown noise + randomized wood crackle & snap pops.
...
- **⏱️ Glowing Pomodoro Timer**:
  ...
  - Automatic sound gating: Ambient audio only plays while the timer is actively running!
  - Tibetan singing bowl multi-harmonic completion chime.
...
| <kbd>Z</kbd> | Toggle Distraction-Free Zen Mode |
| <kbd>Esc</kbd> | Exit Zen Mode |
| <kbd>1</kbd> - <kbd>4</kbd> | Quick-switch Soundscape Presets |
